...
$link = mysqli_connect("localhost", "root", "", "scat_db");
...
$SQL = "SELECT id FROM aut_noticias WHERE autor_id = '. $_SESSION["id_usuario"].'"; 
$result_id = mysql_query($link, $SQL) or die(mysql_error()); 
